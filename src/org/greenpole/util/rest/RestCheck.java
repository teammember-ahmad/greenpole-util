...
public class RestCheck {
    ...
    private static final String BASE_URI = "http://192.168.10.219:7002/greenpole-engine-general/loginrequest/v1";

    public RestCheck() {
        this.client = javax.ws.rs.client.ClientBuilder.newClient();
        this.webTarget = client.target(BASE_URI).path("authenticateaccount");
    }
